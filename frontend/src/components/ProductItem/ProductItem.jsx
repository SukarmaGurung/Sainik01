        ...
        <div className="product-item-img-container">
            <img  className='product-item-image' src={url+"/images/" +image} alt="" />
            {
                ...
                : <div className="product-item-counter">
                    <img  onClick={()=>removeFromCart(id)}src={ assets.substract_icon_circle} alt=''height={20} width={20} />
                    <p>{cartItems[id]}</p>
                    <img  onClick={()=>addToCart(id)}src={ assets.plus_icon_circle} alt=''height={20} width={20} />
